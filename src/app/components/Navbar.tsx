...
export default function Navbar() {
  ...
  return (
    ...
    >
      ...
      <Link href="/" className="flex items-center gap-2 group transition-colors duration-1000">
      ...
      <div className="flex items-center gap-4 md:gap-6 transition-colors duration-1000">
        ...
        <a href="#work" className="text-black dark:text-white hover:text-purple-600 dark:hover:text-purple-300 transition-colors duration-1000 hidden md:block">
          Projetos
        </a>
        ...
        >
          ...
          <span className="hidden md:block">Currículo</span>
        </motion.a>
      </div>
    </motion.nav>
  );
